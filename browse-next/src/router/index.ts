...
const recordingModalTabChildren = (grandParent: string, parent: string) => [
  ...
  {
    path: "location/:trackId?/:detail?",
    name: `${grandParent}-${parent}-info`,
    component: () => import("@/components/RecordingViewMetadata.vue"),
  },
];
...
const router = createRouter({
  ...
  routes: [
    ...
    {
      path: "/:projectName/audio",
      name: "dashboard-audio",
      meta: {
        title: ":projectName Audio Dashboard",
        requiresLogin: true,
